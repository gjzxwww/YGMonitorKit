...
typedef NS_ENUM(NSUInteger, YGCallStackType) {
    YGCallStackTypeAll,     //全部线程
    YGCallStackTypeMain,    //主线程
    YGCallStackTypeCurrent  //当前线程
};



@interface YGCallStack : NSObject

+ (NSString *)callStackWithType:(YGCallStackType)type;

extern NSString *YGStackOfThread(thread_t thread);
@end
